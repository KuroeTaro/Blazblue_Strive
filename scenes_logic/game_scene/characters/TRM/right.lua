...
function load_game_scene_obj_char_RP()
    ...
    obj_char_game_scene_char_RP["ground_smoke_spawn_anchor_pos"]["stand_hurt_high"] = {-70,-195}
...
function load_game_scene_hurtbox_data_RP()
    ...
    obj_hurtboxs_data_game_scene_char_RP["stand_hurt_high"][1] = {{2, -200, 260, 400},{-21, -430, 100, 60}}
    obj_hurtboxs_data_game_scene_char_RP["stand_hurt_high"][2] = {{2, -200, 300, 400}}
