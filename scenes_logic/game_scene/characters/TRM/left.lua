...
function order_load_game_scene_char_LP_frames(load_order)
    ...
    local switch = 
    {
        [1] = function()
            ...
            image_sprite_sheet_table_char_game_scene_LP["6_walk_stop"] = 
            sprite_sheet_load(
            ...
            image_sprite_sheet_table_char_game_scene_LP["4_walk_stop"] = 
            sprite_sheet_load(
...
function load_game_scene_anim_char_LP()
    ...
    anim_char_LP_6_walk_stop = load_game_scene_anim_char_TRM_6_walk_stop(obj_char)
    anim_char_LP_4_walk_stop = load_game_scene_anim_char_TRM_4_walk_stop(obj_char)
    -- overdrive启动动画
...
function load_game_scene_hurtbox_data_LP()
    ...
    obj_hurtboxs_data_game_scene_char_LP["stand_hurt_high"][1] = {{2, -200, 230, 400},{-21, -430, 100, 60}}
    obj_hurtboxs_data_game_scene_char_LP["stand_hurt_high"][2] = {{2, -200, 260, 400}}
...
function state_gate_game_scene_char_LP_from_6_and_4_walk(input,obj_char)
    ...
    elseif common_game_scene_get_input_direction(obj_char) == 5 then
        ...
        if obj_char["sprite_sheet_state"] == "4" then
            obj_char["current_animation"] = anim_char_LP_4_walk_stop
        elseif obj_char["sprite_sheet_state"] == "6" then
            obj_char["current_animation"] = anim_char_LP_6_walk_stop
        end
        init_character_anim_with(obj_char,obj_char["current_animation"])
